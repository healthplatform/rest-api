...
export function test_sdk(app) {
    return {
        register: function register(user: IUser, cb: auth_test_sdk_cb) {
        ...
        login: function login(user: IUserBase, cb: auth_test_sdk_cb) {
        ...
        get_user: function get_user(access_token: string, user: IUser | IUserBase, cb: auth_test_sdk_cb) {
        ...
        logout: function logout(access_token: string, cb: auth_test_sdk_cb) {
        ...
        unregister: function unregister(ident: { access_token?: string, user_id?: string }, cb: auth_test_sdk_cb) {
...
export function unregister_all(sdk: ITestSDK, users: Array<IUser | IUserBase>, done: auth_test_sdk_cb) {
